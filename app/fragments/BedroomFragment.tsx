...
interface BedroomFragmentProps {
  images: string[];
}

function BedroomImageDescription({ image, similarImages, onClose }: { image: string, similarImages: string[], onClose: () => void }) {
  return (
    <div className='h-[85vh] z-[9999] absolute bottom-0 w-full -ml-14 bg-white items-start justify-start px-20 flex'>
      <div className="grid grid-cols-2 gap-8 relative">
        <div className="py-16 flex flex-col gap-2">
          ...
          <div className="">
            <p className='text-sm font-sans'>Posted by Bigglessss · 2 days ago</p>
          </div>
        ...
        <div className="py-16">
          <h2 className="text-4xl font-medium font-sans mb-4">Modern Bedroom Design · GHS1,600.00</h2>
          <p className="text-gray-700 mb-6">
            This modern bedroom offers a tranquil and comfortable space with a touch of luxury. The spacious layout 
            and carefully chosen decor create a relaxing environment, perfect for unwinding after a long day.
          </p>
          <p className="text-gray-700 mb-6">
            The bed is the focal point of the room, featuring a plush headboard and high-quality linens. 
            The room is accented with soft lighting and warm colors that enhance the cozy atmosphere.
          </p>
          <p className="text-gray-700 mb-6">
            Ample storage space is provided with built-in wardrobes, and a stylish dresser complements the overall design.
            The large windows allow plenty of natural light, creating a bright and airy feel.
          </p>
        </div>
        {/* Close Button */}
        <button
...
const BedroomFragment: React.FC<BedroomFragmentProps> = ({ images }) => {
...
export default BedroomFragment;
